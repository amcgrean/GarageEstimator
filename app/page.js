...
function buildRows(inputs,result){
  ...
  const all=[
    ...
    ['Framing',"Treated Plate 12'",'Each',TREATED_CODES[wt][12],result.treatedMudsillEach],
    ['Framing',"Treated Plate 14'",'Each',TREATED_CODES[wt][14],result.treatedMudsillEach],
    ['Framing',"Treated Plate 16'",'Each',TREATED_CODES[wt][16],result.treatedMudsillEach],
    ['Framing','Wall Studs','Each',STUD_CODES[wt][wh],result.studCount],
    ['Framing',"Wall Whitewood 12'",'Each',WIND_WASH_CODES[wt][12],result.windWashFramingCount],
    ['Framing',"Wall Whitewood 14'",'Each',WIND_WASH_CODES[wt][14],result.windWashFramingCount],
    ['Framing',"Wall Whitewood 16'",'Each',WIND_WASH_CODES[wt][16],result.windWashFramingCount],
