...
export function buildTakeoffRows(inputs, result) {
  ...
  const allRows = [
    ...
    ['Framing', "Treated Plate 12'",            'Each', TREATED_CODES[wallThickness][12],       result.treatedMudsillEach],
    ['Framing', "Treated Plate 14'",            'Each', TREATED_CODES[wallThickness][14],       result.treatedMudsillEach],
    ['Framing', "Treated Plate 16'",            'Each', TREATED_CODES[wallThickness][16],       result.treatedMudsillEach],
    ['Framing', 'Wall Studs',                   'Each', STUD_CODES[wallThickness][wallHeight],  result.studCount],
    ['Framing', "Wall Whitewood 12'",           'Each', WIND_WASH_CODES[wallThickness][12],     result.windWashFramingCount],
    ['Framing', "Wall Whitewood 14'",           'Each', WIND_WASH_CODES[wallThickness][14],     result.windWashFramingCount],
    ['Framing', "Wall Whitewood 16'",           'Each', WIND_WASH_CODES[wallThickness][16],     result.windWashFramingCount],
    ...
    ['Framing', "Soffit Whitewood 2x4 12'",     'Each', '0204ww12',                             result.windWash2x4Count],
    ['Framing', "Soffit Whitewood 2x4 14'",     'Each', '0204ww14',                             result.windWash2x4Count],
    ['Framing', "Soffit Whitewood 2x4 16'",     'Each', '0204ww16',                             result.windWash2x4Count],
    ['Framing', "Rake Whitewood 2x6 12'",       'Each', '0206ww12',                             result.windWash2x6Count],
    ['Framing', "Rake Whitewood 2x6 14'",       'Each', '0206ww14',                             result.windWash2x6Count],
    ['Framing', "Rake Whitewood 2x6 16'",       'Each', '0206ww16',                             result.windWash2x6Count],
